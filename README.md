...
**Rendimiento** Por ejemplo ahora Facebook, podría acceder a los datos de logeo de un usuario en un archivo que tenga más de 300 millones de llaves, en solo 2.4 milli-segundos desde un simple ordenador domestico, que tenga como mínimo, un procesador de un solo núcleo, 160 GB de disco y 256 MB de RAM.
...
*PASO 3*
- Ya puedes instalar DelosData en Python 2.7, ejecutando el archivo [instalar.py](instalar.py)
...
**Traducción** Soporte para documentación y comentarios en ingles
